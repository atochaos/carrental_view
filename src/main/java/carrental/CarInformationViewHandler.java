        ...
        try {
            if (carRegistered.isMe()) {
                ...
                if (!(carRegistered.getCarNo()==null)) {
                    ...
                    System.out.println("##### listener setgetCarNo : " + carRegistered.getCarNo());
                    System.out.println("##### listener setCarRegDt : " + carRegistered.getCarRegDt());
                    System.out.println("##### listener setProcStatus : " + carRegistered.getProcStatus());
                    System.out.println("##### listener setRentalAmt : " + carRegistered.getRentalAmt());
        ...
        try {
            if (carUpdated.isMe()) {
                ...
                for(CarInformation carInformation : carInformationList){
                    ...
                    System.out.println("##### listener setProcStatus : " + carUpdated.getProcStatus());
        ...
        try {
            if (carDeleted.isMe()) {
                ...
                for(CarInformation carInformation : carInformationList){
                    ...
                    System.out.println("##### listener setProcStatus : " + carDeleted.getProcStatus());
        ...
        try {
            if (carUpdated.isMe()) {
                ...
                for(CarInformation carInformation : carInformationList){
                    ...
                    System.out.println("##### listener setProcStatus : " + carUpdated.getProcStatus());
                    System.out.println("##### listener setRentalAmt : " + carUpdated.getRentalAmt());
                    System.out.println("##### listener whenCarUpdated_then_DELETE_1 [VIEW] : " + carInformation.getCarNo());
                    // view 레파지토리에 save
                    carInformationRepository.save(carInformation);
                }
            }
